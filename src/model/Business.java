...
public class Business {
	...
	private static String[] recettes = { "Course", "Location", "Abonnement",
			"Autre", "Erreur" };
	private static String[] depenses = { "Location", "Essence", "Réparations",
			"Entretien", "Stationnement", "Lavage", "Assurance", "Amende",
			"Association", "Enregistrement", "Contrôle technique", "Autre",
			"Erreur" };
	private static String[] pertes = {"Social", "Vol", "Erreur"};
	...
	public static void loadStateDepenses() {
		...
		if (!loaded) {
			...
			// depensesMap.put("Contrôle technique", new Double(0));
