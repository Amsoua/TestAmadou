...
public class AboutScreen extends Form implements CommandListener {
	...
	public AboutScreen() {
		...
		this.append("SenMobile respecte la vie privée de ses clients. Lorsque l'utilisateur utilise la fonction SMS pour envoyer un SMS, l'application n'utilise cette information qu'une seule fois pour envoyer le SMS. Elle ne recueille pas et ne stocke pas le numéro de téléphone utilisé. L'application ne collecte aucune information.");
